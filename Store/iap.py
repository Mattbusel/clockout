"""Clockout Pro: the one in-app purchase, and the switch from paid to free.
...
PRODUCT_ID = "com.mattbusel.clockout.pro"
NAME = "Clockout Pro"
PRICE = "4.99"
DESCRIPTION = "Insights, paycheck check, tax year CSV, more jobs."  # 55 chars max
REVIEW_NOTE = (
    "Non-consumable, one-time unlock. The app is free; logging unlimited shifts for one job, the Tonight "
    "screen, the Shifts list and the real hourly rate are free forever. Pro unlocks the Insights tab, the "
    "Money tab (paycheck check, tax year totals, CSV export) and adding a second job. To see the paywall: "
    "tap the Insights or Money tab and tap See Clockout Pro, or tap the gear on the Tonight screen and tap "
    "SEE on the Clockout Pro card. Restore purchase is on the paywall and under SEE on that card."
)
